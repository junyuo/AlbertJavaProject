...
public class StringFormatExampleTest {
    ...
    public void setup() {
        ...
        unformatedMessage = "驗證碼傳送成功。手機號碼: {0}, 驗整碼: {1}";
        anotherUnformatedMessage = "驗證碼傳送失敗。錯誤訊息: {1}, 手機號碼: {0}";
        phone = "0910123456";
        otp = "12345";
    ...
    public void testGetFormattedMessage() {
        ...
        assertEquals("驗證碼傳送成功。手機號碼: 0910123456, 驗整碼: 12345", formatedMsg);
        ...
        assertEquals("驗證碼傳送失敗。錯誤訊息: HTTP Server is down, 手機號碼: 0910123456", anotherFormatedMsg);
    }
